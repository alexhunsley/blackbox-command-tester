...
Unit testing is great. If approprite, use it!
...
* You want to aggressively refactor an existing tool without wasting time writing unit tests that will soon become unusable due to the refactoring
